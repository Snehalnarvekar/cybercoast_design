...
class ThemeBlog extends RA_Blog {
	...
	public function __construct() {
		$this->atts = array(
			...
			'enable_parallax' => rella_helper()->get_option( 'blog-enable-parallax' ),
			'show_meta' => rella_helper()->get_option( 'blog-show-meta' ),
			'meta_type' => rella_helper()->get_option( 'blog-meta-type' ),
			'one_category' => rella_helper()->get_option( 'blog-one-category' ),
		);
