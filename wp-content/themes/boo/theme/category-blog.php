<?php
/**
 * Category Blog class for blog posts page and blog archives
 */

class CategoryBlog extends RA_Blog {
	...
	public function __construct() {
		$this->atts = array(
			'style'               => rella_helper()->get_option( 'category-blog-style' ),
			'pagination'          => rella_helper()->get_option( 'category-blog-pagination' ),
			'enable_parallax'     => rella_helper()->get_option( 'category-blog-enable-parallax' ),
			'show_meta'           => rella_helper()->get_option( 'category-blog-show-meta' ),
			'meta_type'           => rella_helper()->get_option( 'category-blog-meta-type' ),
			'one_category'        => rella_helper()->get_option( 'category-blog-one-category' ),
			'post_excerpt_length' => rella_helper()->get_option( 'category-blog-excerpt-length' ),
		);
