...
<?php 
            if ( false === $this->parent->args['hide_save'] ) {
                submit_button( esc_html__( 'Save Changes', 'boo' ), 'primary', 'redux_save', false );
                echo '&nbsp';
            }

            if ( false === $this->parent->args['hide_reset'] ) {
                submit_button( esc_html__( 'Reset Section', 'boo' ), 'secondary', $this->parent->args['opt_name'] . '[defaults-section]', false, array( 'id' => 'redux-defaults-section' ) );
                echo '&nbsp';
                submit_button( esc_html__( 'Reset All', 'boo' ), 'secondary', $this->parent->args['opt_name'] . '[defaults]', false, array( 'id' => 'redux-defaults' ) );
            } 
?>
        </div>

        <div class="redux-ajax-loading" alt="<?php esc_html_e( 'Working...', 'boo' ) ?>">&nbsp;</div>
        <div class="clear"></div>
