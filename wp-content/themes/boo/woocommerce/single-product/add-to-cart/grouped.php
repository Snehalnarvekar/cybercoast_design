					...
					?>
						...
						<td class="label">
							<label for="product-<?php echo $grouped_product_child->get_id(); ?>">
								<?php echo $grouped_product_child->is_visible() ? '<a href="' . esc_url( apply_filters( 'woocommerce_grouped_product_list_link', get_permalink(), $grouped_product_child->get_id() ) ) . '">' . $grouped_product_child->get_name() . '</a>' : $grouped_product_child->get_name(); ?>
							</label>
						</td>
