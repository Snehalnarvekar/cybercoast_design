...
if ( $max_value && $min_value === $max_value ) {
	...
	?>
	<div class="quantity">
		<label class="screen-reader-text" for="<?php echo esc_attr( $input_id ); ?>"><?php esc_html_e( 'Quantity', 'boo' ); ?></label>
		<input
			type="number"
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'boo' ); ?>"
			size="4"
