...
function rella_breadcrumb( $args = array() ) {
	...
	if( 
		...
		$breadcrumb = woocommerce_breadcrumb( $args );
		return $breadcrumb;
	}
	else {
 ...
 */
add_filter( 'woocommerce_breadcrumb_defaults', 'boo_woocommerce_breadcrumbs' );
function boo_woocommerce_breadcrumbs() {
    return array(
            'delimiter'   => '',
            'wrap_before' => '<nav class="breadcrumbs" itemprop="breadcrumb"><ol class="breadcrumb">',
            'wrap_after'  => '</ol></nav>',
            'before'      => '<li class="breadcrumb-item">',
            'after'       => '</li>',
            'home' => _x( 'Home', 'breadcrumb', 'boo' ),
        );
}
