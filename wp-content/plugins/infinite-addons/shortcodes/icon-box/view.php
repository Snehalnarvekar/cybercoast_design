...
// classes
$classes = array( $this->get_class( $template ), $this->get_shape( $background_shape ), $this->get_shape_size(), $heading_size, $position, $alignment, $valignment, $border_hover_color, $this->static_shadow(), $this->get_counter_classes(), $el_class, $this->get_id(), trim( vc_shortcode_custom_css_class( $css ) ) );
